...
//--- return value of prev_calculated for next call
   ...
   color M1_Label_color_MOD_inM1 = Text_Color;
   int MA_HandleM1 = iRSI(_Symbol,PERIOD_M1,RSI_Var,PRICE_CLOSE);
   double MAarrayM1[];
   ...
   color M5_Label_color_MOD_inM5 = Text_Color;
   int MA_HandleM5 = iRSI(_Symbol,PERIOD_M5,RSI_Var,PRICE_CLOSE);
   double MAarrayM5[];
   ...
   color M15_Label_color_MOD_inM15 = Text_Color;
   int MA_HandleM15 = iRSI(_Symbol,PERIOD_M15,RSI_Var,PRICE_CLOSE);
   double MAarrayM15[];
   ...
   color M30_Label_color_MOD_inM30 = Text_Color;
   int MA_HandleM30 = iRSI(_Symbol,PERIOD_M30,RSI_Var,PRICE_CLOSE);
   double MAarrayM30[];
   ...
   color H1_Label_color_MOD_inH1 = Text_Color;
   int MA_HandleH1 = iRSI(_Symbol,PERIOD_H1,RSI_Var,PRICE_CLOSE);
   double MAarrayH1[];
   ...
   color H4_Label_color_MOD_inH4 = Text_Color;
   int MA_HandleH4 = iRSI(_Symbol,PERIOD_H4,RSI_Var,PRICE_CLOSE);
   double MAarrayH4[];
   ...
   color D1_Label_color_MOD_inD1 = Text_Color;
   int MA_HandleD1 = iRSI(_Symbol,PERIOD_D1,RSI_Var,PRICE_CLOSE);
   double MAarrayD1[];
   ...
   color W1_Label_color_MOD_inW1 = Text_Color;
   int MA_HandleW1 = iRSI(_Symbol,PERIOD_W1,RSI_Var,PRICE_CLOSE);
   double MAarrayW1[];
   ...
   color MN1_Label_color_MOD_inMN1 = Text_Color;
   int MA_HandleMN1 = iRSI(_Symbol,PERIOD_MN1,RSI_Var,PRICE_CLOSE);
   double MAarrayMN1[];
